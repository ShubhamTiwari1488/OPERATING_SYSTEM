...
int main(int argc, char **argv)
{
  ...
  17:	68 18 08 00 00       	push   $0x818
  1c:	6a 01                	push   $0x1
  1e:	e8 8d 04 00 00       	call   4b0 <printf>
	int i, a[2]={0};
    printf(1, "parent:%d %d\n", getpid(),getppid());
  23:	e8 b3 03 00 00       	call   3db <getppid>
  28:	89 c6                	mov    %eax,%esi
  2a:	e8 84 03 00 00       	call   3b3 <getpid>
  2f:	56                   	push   %esi
  30:	50                   	push   %eax
  31:	68 34 08 00 00       	push   $0x834
  36:	6a 01                	push   $0x1
  38:	e8 73 04 00 00       	call   4b0 <printf>
    	for(i=0;i<2;i++)
    	{
    	 	a[i]=fork();
  ...
  50:	50                   	push   %eax
  51:	56                   	push   %esi
  52:	68 42 08 00 00       	push   $0x842
  57:	6a 01                	push   $0x1
  59:	e8 52 04 00 00       	call   4b0 <printf>
    			wait();
  ...
  76:	50                   	push   %eax
  77:	53                   	push   %ebx
  78:	68 42 08 00 00       	push   $0x842
  7d:	6a 01                	push   $0x1
  7f:	e8 2c 04 00 00       	call   4b0 <printf>
    			wait();
  ...
  8f:	53                   	push   %ebx
  90:	e8 56 03 00 00       	call   3eb <waitpid>
  95:	89 c3                	mov    %eax,%ebx
    	printf(1,"WAIT:%d %d\n",c,getpid());
  97:	e8 17 03 00 00       	call   3b3 <getpid>
  9c:	50                   	push   %eax
  9d:	53                   	push   %ebx
  9e:	68 50 08 00 00       	push   $0x850
  a3:	6a 01                	push   $0x1
