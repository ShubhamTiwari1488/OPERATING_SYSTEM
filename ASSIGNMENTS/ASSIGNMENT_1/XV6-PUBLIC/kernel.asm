...
801003c4:	e8 e7 02 00 00       	call   801006b0 <cprintf>
  cprintf("\n");
801003c9:	c7 04 24 6d 7a 10 80 	movl   $0x80107a6d,(%esp)
...
80103804:	89 53 18             	mov    %edx,0x18(%ebx)
  *(uint*)sp = (uint)trapret;
80103807:	c7 40 14 ff 5b 10 80 	movl   $0x80105bff,0x14(%eax)
  p->context = (struct context*)sp;
...
801039a7:	e8 14 38 00 00       	call   801071c0 <setupkvm>
...
801039c5:	e8 c6 34 00 00       	call   80106e90 <inituvm>
...
80103abf:	e8 bc 32 00 00       	call   80106d80 <switchuvm>
  return 0;
...
80103b4c:	e8 3f 37 00 00       	call   80107290 <copyuvm>
...
80103c80:	e8 fb 30 00 00       	call   80106d80 <switchuvm>
...
8010407a:	c7 43 08 00 00 00 00 	movl   $0x0,0x8(%ebx)
        freevm(p->pgdir);
80104081:	e8 ba 30 00 00       	call   80107140 <freevm>
        release(&ptable.lock);
...
801041f3:	68 6d 7a 10 80       	push   $0x80107a6d
...
80104220:	8b 14 85 88 7b 10 80 	mov    -0x7fef8478(,%eax,4),%edx
      state = "???";
...
801042b1:	bb 54 2d 11 80       	mov    $0x80112d54,%ebx
 acquire(&ptable.lock);
801042b6:	e8 65 05 00 00       	call   80104820 <acquire>
 cprintf("name \t pid \t state \t \n");
801042bb:	c7 04 24 58 7a 10 80 	movl   $0x80107a58,(%esp)
...
801042fa:	68 6f 7a 10 80       	push   $0x80107a6f
...
80104317:	e8 c4 05 00 00       	call   801048e0 <release>
...
8010433a:	68 8a 7a 10 80       	push   $0x80107a8a
...
8010435a:	68 a4 7a 10 80       	push   $0x80107aa4
...
80104378:	83 ec 04             	sub    $0x4,%esp
  pushcli();
8010437b:	e8 a0 03 00 00       	call   80104720 <pushcli>
  c = mycpu();
80104380:	e8 4b f5 ff ff       	call   801038d0 <mycpu>
  p = c->proc;
80104385:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
8010438b:	e8 e0 03 00 00       	call   80104770 <popcli>
 struct proc *p = myproc();
 
 cprintf("PID is %d \n",p->pid);
80104390:	83 ec 08             	sub    $0x8,%esp
80104393:	ff 73 10             	pushl  0x10(%ebx)
80104396:	68 bf 7a 10 80       	push   $0x80107abf
8010439b:	e8 10 c3 ff ff       	call   801006b0 <cprintf>
 cprintf("PPID is %d \n",p->parent->pid);
801043a0:	58                   	pop    %eax
801043a1:	8b 43 14             	mov    0x14(%ebx),%eax
801043a4:	5a                   	pop    %edx
801043a5:	ff 70 10             	pushl  0x10(%eax)
801043a8:	68 be 7a 10 80       	push   $0x80107abe
801043ad:	e8 fe c2 ff ff       	call   801006b0 <cprintf>
 cprintf("Process name is %s \n",p->name);
801043b2:	59                   	pop    %ecx
801043b3:	58                   	pop    %eax
801043b4:	8d 43 6c             	lea    0x6c(%ebx),%eax
801043b7:	50                   	push   %eax
801043b8:	68 cb 7a 10 80       	push   $0x80107acb
801043bd:	e8 ee c2 ff ff       	call   801006b0 <cprintf>
 
 //cprintf("Parent Process name is %s \n",p->parent->name);
 
 if(p->state == SLEEPING)
801043c2:	8b 43 0c             	mov    0xc(%ebx),%eax
801043c5:	83 c4 10             	add    $0x10,%esp
801043c8:	83 f8 02             	cmp    $0x2,%eax
801043cb:	74 1b                	je     801043e8 <sps+0x78>
 	cprintf("Process state is SLEEPING \n");
 	
 else if(p->state == RUNNING)
801043cd:	83 f8 04             	cmp    $0x4,%eax
801043d0:	74 36                	je     80104408 <sps+0x98>
 	cprintf("Process state is RUNNING \n");
 	
 else if(p->state == RUNNABLE)
801043d2:	83 f8 03             	cmp    $0x3,%eax
801043d5:	74 51                	je     80104428 <sps+0xb8>
 	cprintf("Process state is RUNNABLE \n");
 	
 return 24;
}
801043d7:	8b 5d fc             	mov    -0x4(%ebp),%ebx
801043da:	b8 18 00 00 00       	mov    $0x18,%eax
801043df:	c9                   	leave  
801043e0:	c3                   	ret    
801043e1:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
 	cprintf("Process state is SLEEPING \n");
801043e8:	83 ec 0c             	sub    $0xc,%esp
801043eb:	68 e0 7a 10 80       	push   $0x80107ae0
801043f0:	e8 bb c2 ff ff       	call   801006b0 <cprintf>
}
801043f5:	8b 5d fc             	mov    -0x4(%ebp),%ebx
801043f8:	83 c4 10             	add    $0x10,%esp
801043fb:	b8 18 00 00 00       	mov    $0x18,%eax
80104400:	c9                   	leave  
80104401:	c3                   	ret    
80104402:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
 	cprintf("Process state is RUNNING \n");
80104408:	83 ec 0c             	sub    $0xc,%esp
8010440b:	68 fc 7a 10 80       	push   $0x80107afc
80104410:	e8 9b c2 ff ff       	call   801006b0 <cprintf>
}
80104415:	8b 5d fc             	mov    -0x4(%ebp),%ebx
80104418:	83 c4 10             	add    $0x10,%esp
8010441b:	b8 18 00 00 00       	mov    $0x18,%eax
80104420:	c9                   	leave  
80104421:	c3                   	ret    
80104422:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
 	cprintf("Process state is RUNNABLE \n");
80104428:	83 ec 0c             	sub    $0xc,%esp
8010442b:	68 17 7b 10 80       	push   $0x80107b17
80104430:	e8 7b c2 ff ff       	call   801006b0 <cprintf>
}
80104435:	8b 5d fc             	mov    -0x4(%ebp),%ebx
 	cprintf("Process state is RUNNABLE \n");
80104438:	83 c4 10             	add    $0x10,%esp
}
8010443b:	b8 18 00 00 00       	mov    $0x18,%eax
80104440:	c9                   	leave  
80104441:	c3                   	ret    
...
8010445d:	8b 7d 08             	mov    0x8(%ebp),%edi
  pushcli();
80104460:	e8 bb 02 00 00       	call   80104720 <pushcli>
  c = mycpu();
80104465:	e8 66 f4 ff ff       	call   801038d0 <mycpu>
  p = c->proc;
8010446a:	8b 80 ac 00 00 00    	mov    0xac(%eax),%eax
80104470:	89 45 e4             	mov    %eax,-0x1c(%ebp)
  popcli();
80104473:	e8 f8 02 00 00       	call   80104770 <popcli>
    struct proc *p;
    int child, pid;
    struct proc *curproc=myproc();
...
80104480:	e8 9b 03 00 00       	call   80104820 <acquire>
80104485:	8b 45 e4             	mov    -0x1c(%ebp),%eax
80104488:	83 c4 10             	add    $0x10,%esp
    for(;;){
      child=0;
8010448b:	31 d2                	xor    %edx,%edx
      for(p=ptable.proc;p<&ptable.proc[NPROC];p++){
8010448d:	bb 54 2d 11 80       	mov    $0x80112d54,%ebx
80104492:	eb 0f                	jmp    801044a3 <waitpid+0x53>
80104494:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
80104498:	83 c3 7c             	add    $0x7c,%ebx
8010449b:	81 fb 54 4c 11 80    	cmp    $0x80114c54,%ebx
801044a1:	74 22                	je     801044c5 <waitpid+0x75>
        if(p->pid!=cpid || p->parent!=curproc)
801044a3:	8b 73 10             	mov    0x10(%ebx),%esi
801044a6:	39 fe                	cmp    %edi,%esi
801044a8:	75 ee                	jne    80104498 <waitpid+0x48>
801044aa:	39 43 14             	cmp    %eax,0x14(%ebx)
801044ad:	75 e9                	jne    80104498 <waitpid+0x48>
            continue;
        child=1;
        if(p->state==ZOMBIE){
801044af:	83 7b 0c 05          	cmpl   $0x5,0xc(%ebx)
801044b3:	74 3b                	je     801044f0 <waitpid+0xa0>
      for(p=ptable.proc;p<&ptable.proc[NPROC];p++){
801044b5:	83 c3 7c             	add    $0x7c,%ebx
        child=1;
801044b8:	ba 01 00 00 00       	mov    $0x1,%edx
      for(p=ptable.proc;p<&ptable.proc[NPROC];p++){
801044bd:	81 fb 54 4c 11 80    	cmp    $0x80114c54,%ebx
801044c3:	75 de                	jne    801044a3 <waitpid+0x53>
           release(&ptable.lock);
           return pid;
         }
      }
...
801044c7:	74 7b                	je     80104544 <waitpid+0xf4>
801044c9:	8b 50 24             	mov    0x24(%eax),%edx
801044cc:	85 d2                	test   %edx,%edx
801044ce:	75 74                	jne    80104544 <waitpid+0xf4>
        release(&ptable.lock);
        return -1;
      }     
...
801044d3:	89 45 e4             	mov    %eax,-0x1c(%ebp)
801044d6:	68 20 2d 11 80       	push   $0x80112d20
801044db:	50                   	push   %eax
801044dc:	e8 3f fa ff ff       	call   80103f20 <sleep>
      child=0;
801044e1:	8b 45 e4             	mov    -0x1c(%ebp),%eax
801044e4:	83 c4 10             	add    $0x10,%esp
801044e7:	eb a2                	jmp    8010448b <waitpid+0x3b>
801044e9:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
           kfree(p->kstack);
801044f0:	83 ec 0c             	sub    $0xc,%esp
801044f3:	ff 73 08             	pushl  0x8(%ebx)
801044f6:	e8 75 df ff ff       	call   80102470 <kfree>
           freevm(p->pgdir);
801044fb:	59                   	pop    %ecx
801044fc:	ff 73 04             	pushl  0x4(%ebx)
           p->kstack=0;
801044ff:	c7 43 08 00 00 00 00 	movl   $0x0,0x8(%ebx)
           freevm(p->pgdir);
80104506:	e8 35 2c 00 00       	call   80107140 <freevm>
           release(&ptable.lock);
8010450b:	c7 04 24 20 2d 11 80 	movl   $0x80112d20,(%esp)
           p->pid=0;
...
8010452b:	c7 43 0c 00 00 00 00 	movl   $0x0,0xc(%ebx)
           release(&ptable.lock);
80104532:	e8 a9 03 00 00       	call   801048e0 <release>
           return pid;
80104537:	83 c4 10             	add    $0x10,%esp
    }
}
8010453a:	8d 65 f4             	lea    -0xc(%ebp),%esp
8010453d:	89 f0                	mov    %esi,%eax
8010453f:	5b                   	pop    %ebx
80104540:	5e                   	pop    %esi
80104541:	5f                   	pop    %edi
80104542:	5d                   	pop    %ebp
...
80104544:	83 ec 0c             	sub    $0xc,%esp
        return -1;
80104547:	be ff ff ff ff       	mov    $0xffffffff,%esi
        release(&ptable.lock);
8010454c:	68 20 2d 11 80       	push   $0x80112d20
80104551:	e8 8a 03 00 00       	call   801048e0 <release>
        return -1;
80104556:	83 c4 10             	add    $0x10,%esp
80104559:	eb df                	jmp    8010453a <waitpid+0xea>
...
8010456e:	68 a0 7b 10 80       	push   $0x80107ba0
...
801047b5:	68 ab 7b 10 80       	push   $0x80107bab
801047ba:	e8 d1 bb ff ff       	call   80100390 <panic>
    panic("popcli");
801047bf:	83 ec 0c             	sub    $0xc,%esp
801047c2:	68 c2 7b 10 80       	push   $0x80107bc2
...
801048c7:	68 c9 7b 10 80       	push   $0x80107bc9
...
80104920:	68 d1 7b 10 80       	push   $0x80107bd1
...
80104d1b:	83 fa 19             	cmp    $0x19,%edx
80104d1e:	77 20                	ja     80104d40 <syscall+0x40>
80104d20:	8b 14 85 00 7c 10 80 	mov    -0x7fef8400(,%eax,4),%edx
...
80104d48:	68 d9 7b 10 80       	push   $0x80107bd9
...
80104ea4:	68 88 7c 10 80       	push   $0x80107c88
...
80104ebc:	68 87 7c 10 80       	push   $0x80107c87
...
80104ed1:	68 7b 7c 10 80       	push   $0x80107c7b
...
80104eef:	68 8a 7c 10 80       	push   $0x80107c8a
80104ef4:	e8 97 b4 ff ff       	call   80100390 <panic>
    panic("create: ialloc");
80104ef9:	83 ec 0c             	sub    $0xc,%esp
80104efc:	68 6c 7c 10 80       	push   $0x80107c6c
...
801052ed:	58                   	pop    %eax
801052ee:	5a                   	pop    %edx
801052ef:	68 88 7c 10 80       	push   $0x80107c88
...
80105308:	68 87 7c 10 80       	push   $0x80107c87
...
80105a74:	68 60 4c 11 80       	push   $0x80114c60
80105a79:	e8 a2 ed ff ff       	call   80104820 <acquire>
  ticks0 = ticks;
  while(ticks - ticks0 < n){
80105a7e:	8b 55 f4             	mov    -0xc(%ebp),%edx
  ticks0 = ticks;
80105a81:	8b 1d a0 54 11 80    	mov    0x801154a0,%ebx
  while(ticks - ticks0 < n){
...
80105a93:	68 60 4c 11 80       	push   $0x80114c60
80105a98:	68 a0 54 11 80       	push   $0x801154a0
80105a9d:	e8 7e e4 ff ff       	call   80103f20 <sleep>
  while(ticks - ticks0 < n){
80105aa2:	a1 a0 54 11 80       	mov    0x801154a0,%eax
...
80105ac0:	68 60 4c 11 80       	push   $0x80114c60
...
80105b08:	83 ec 10             	sub    $0x10,%esp
  ...
  acquire(&tickslock);
80105b0b:	68 60 4c 11 80       	push   $0x80114c60
80105b10:	e8 0b ed ff ff       	call   80104820 <acquire>
  xticks = ticks;
80105b15:	8b 1d a0 54 11 80    	mov    0x801154a0,%ebx
  release(&tickslock);
80105b1b:	c7 04 24 60 4c 11 80 	movl   $0x80114c60,(%esp)
...
80105b30:	f3 0f 1e fb          	endbr32 
 return cps();
80105b34:	e9 67 e7 ff ff       	jmp    801042a0 <cps>
...
80105b4f:	8b 40 14             	mov    0x14(%eax),%eax
...
80105b60:	f3 0f 1e fb          	endbr32 
 return sps();
80105b64:	e9 07 e8 ff ff       	jmp    80104370 <sps>
80105b69:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi

80105b70 <sys_waitpid>:
}
...
80105b8a:	78 14                	js     80105ba0 <sys_waitpid+0x30>
    return -1;
     return waitpid(pid);
80105b8c:	83 ec 0c             	sub    $0xc,%esp
80105b8f:	ff 75 f4             	pushl  -0xc(%ebp)
80105b92:	e8 b9 e8 ff ff       	call   80104450 <waitpid>
...
80105bf6:	54                   	push   %esp
  call trap
80105bf7:	e8 c4 00 00 00       	call   80105cc0 <trap>
  addl $4, %esp
...
80105bff:	61                   	popa   
  popl %gs
80105c00:	0f a9                	pop    %gs
  popl %fs
80105c02:	0f a1                	pop    %fs
  popl %es
80105c04:	07                   	pop    %es
  popl %ds
80105c05:	1f                   	pop    %ds
  addl $0x8, %esp  # trapno and errcode
80105c06:	83 c4 08             	add    $0x8,%esp
  iret
80105c09:	cf                   	iret   
...
80105c27:	c7 04 c5 a2 4c 11 80 	movl   $0x8e000008,-0x7feeb35e(,%eax,8)
80105c2e:	08 00 00 8e 
80105c32:	66 89 14 c5 a0 4c 11 	mov    %dx,-0x7feeb360(,%eax,8)
80105c39:	80 
80105c3a:	c1 ea 10             	shr    $0x10,%edx
80105c3d:	66 89 14 c5 a6 4c 11 	mov    %dx,-0x7feeb35a(,%eax,8)
80105c44:	80 
  for(i = 0; i < 256; i++)
...
80105c57:	c7 05 a2 4e 11 80 08 	movl   $0xef000008,0x80114ea2
80105c5e:	00 00 ef 
  initlock(&tickslock, "time");
80105c61:	68 cd 7c 10 80       	push   $0x80107ccd
80105c66:	68 60 4c 11 80       	push   $0x80114c60
  SETGATE(idt[T_SYSCALL], 1, SEG_KCODE<<3, vectors[T_SYSCALL], DPL_USER);
80105c6b:	66 a3 a0 4e 11 80    	mov    %ax,0x80114ea0
80105c71:	c1 e8 10             	shr    $0x10,%eax
80105c74:	66 a3 a6 4e 11 80    	mov    %ax,0x80114ea6
  initlock(&tickslock, "time");
80105c7a:	e8 21 ea ff ff       	call   801046a0 <initlock>
}
...
80105c9f:	66 89 45 fa          	mov    %ax,-0x6(%ebp)
  pd[1] = (uint)p;
80105ca3:	b8 a0 4c 11 80       	mov    $0x80114ca0,%eax
...
80105ce4:	3e ff 24 85 74 7d 10 	notrack jmp *-0x7fef828c(,%eax,4)
80105ceb:	80 
    lapiceoi();
    break;
...
80105cec:	e8 6f dc ff ff       	call   80103960 <myproc>
...
80105d0c:	e8 2f dc ff ff       	call   80103940 <cpuid>
...
80105d25:	e8 36 dc ff ff       	call   80103960 <myproc>
    cprintf("pid %d %s: trap %d err %d on cpu %d "
...
80105d3a:	83 c6 6c             	add    $0x6c,%esi
    cprintf("pid %d %s: trap %d err %d on cpu %d "
80105d3d:	56                   	push   %esi
80105d3e:	ff 70 10             	pushl  0x10(%eax)
80105d41:	68 30 7d 10 80       	push   $0x80107d30
...
80105d5a:	e8 01 dc ff ff       	call   80103960 <myproc>
80105d5f:	85 c0                	test   %eax,%eax
80105d61:	74 1d                	je     80105d80 <trap+0xc0>
80105d63:	e8 f8 db ff ff       	call   80103960 <myproc>
80105d68:	8b 50 24             	mov    0x24(%eax),%edx
...
80105d80:	e8 db db ff ff       	call   80103960 <myproc>
80105d85:	85 c0                	test   %eax,%eax
80105d87:	74 0f                	je     80105d98 <trap+0xd8>
80105d89:	e8 d2 db ff ff       	call   80103960 <myproc>
80105d8e:	83 78 0c 04          	cmpl   $0x4,0xc(%eax)
...
80105dd9:	eb a5                	jmp    80105d80 <trap+0xc0>
    if(cpuid() == 0){
80105ddb:	e8 60 db ff ff       	call   80103940 <cpuid>
80105de0:	85 c0                	test   %eax,%eax
80105de2:	75 e7                	jne    80105dcb <trap+0x10b>
      acquire(&tickslock);
80105de4:	83 ec 0c             	sub    $0xc,%esp
80105de7:	68 60 4c 11 80       	push   $0x80114c60
80105dec:	e8 2f ea ff ff       	call   80104820 <acquire>
      wakeup(&ticks);
80105df1:	c7 04 24 a0 54 11 80 	movl   $0x801154a0,(%esp)
      ticks++;
80105df8:	83 05 a0 54 11 80 01 	addl   $0x1,0x801154a0
      wakeup(&ticks);
80105dff:	e8 dc e2 ff ff       	call   801040e0 <wakeup>
      release(&tickslock);
80105e04:	c7 04 24 60 4c 11 80 	movl   $0x80114c60,(%esp)
80105e0b:	e8 d0 ea ff ff       	call   801048e0 <release>
...
80105e36:	e8 85 ca ff ff       	call   801028c0 <lapiceoi>
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
80105e3b:	e8 20 db ff ff       	call   80103960 <myproc>
...
80105e54:	e8 e7 da ff ff       	call   80103940 <cpuid>
80105e59:	57                   	push   %edi
80105e5a:	56                   	push   %esi
80105e5b:	50                   	push   %eax
80105e5c:	68 d8 7c 10 80       	push   $0x80107cd8
...
80105e6b:	83 c4 10             	add    $0x10,%esp
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
80105e6e:	e8 ed da ff ff       	call   80103960 <myproc>
...
80105e84:	0f 85 0e ff ff ff    	jne    80105d98 <trap+0xd8>
    yield();
80105e8a:	e8 41 e0 ff ff       	call   80103ed0 <yield>
80105e8f:	e9 04 ff ff ff       	jmp    80105d98 <trap+0xd8>
80105e94:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    if(myproc()->killed)
80105e98:	e8 c3 da ff ff       	call   80103960 <myproc>
80105e9d:	8b 70 24             	mov    0x24(%eax),%esi
80105ea0:	85 f6                	test   %esi,%esi
80105ea2:	75 3c                	jne    80105ee0 <trap+0x220>
    myproc()->tf = tf;
80105ea4:	e8 b7 da ff ff       	call   80103960 <myproc>
80105ea9:	89 58 18             	mov    %ebx,0x18(%eax)
    syscall();
80105eac:	e8 4f ee ff ff       	call   80104d00 <syscall>
    if(myproc()->killed)
80105eb1:	e8 aa da ff ff       	call   80103960 <myproc>
80105eb6:	8b 48 24             	mov    0x24(%eax),%ecx
...
80105ec7:	5d                   	pop    %ebp
      exit();
80105ec8:	e9 c3 de ff ff       	jmp    80103d90 <exit>
...
80105ee7:	0f 20 d6             	mov    %cr2,%esi
      cprintf("unexpected trap %d from cpu %d eip %x (cr2=0x%x)\n",
80105eea:	e8 51 da ff ff       	call   80103940 <cpuid>
...
80105ef8:	68 fc 7c 10 80       	push   $0x80107cfc
80105efd:	e8 ae a7 ff ff       	call   801006b0 <cprintf>
      panic("trap");
80105f02:	83 c4 14             	add    $0x14,%esp
80105f05:	68 d2 7c 10 80       	push   $0x80107cd2
...
80106003:	be 76 00 00 00       	mov    $0x76,%esi
  for(p="xv6...\n"; *p; p++)
80106008:	bb f4 7d 10 80       	mov    $0x80107df4,%ebx
  ioapicenable(IRQ_COM1, 0);
...
8010609b:	6a 00                	push   $0x0
  jmp alltraps
8010609d:	e9 45 fb ff ff       	jmp    80105be7 <alltraps>
...
801060a4:	6a 01                	push   $0x1
  jmp alltraps
801060a6:	e9 3c fb ff ff       	jmp    80105be7 <alltraps>
...
801060ad:	6a 02                	push   $0x2
  jmp alltraps
801060af:	e9 33 fb ff ff       	jmp    80105be7 <alltraps>
...
801060b6:	6a 03                	push   $0x3
  jmp alltraps
801060b8:	e9 2a fb ff ff       	jmp    80105be7 <alltraps>
...
801060bf:	6a 04                	push   $0x4
  jmp alltraps
801060c1:	e9 21 fb ff ff       	jmp    80105be7 <alltraps>
...
801060c8:	6a 05                	push   $0x5
  jmp alltraps
801060ca:	e9 18 fb ff ff       	jmp    80105be7 <alltraps>
...
801060d1:	6a 06                	push   $0x6
  jmp alltraps
801060d3:	e9 0f fb ff ff       	jmp    80105be7 <alltraps>
...
801060da:	6a 07                	push   $0x7
  jmp alltraps
801060dc:	e9 06 fb ff ff       	jmp    80105be7 <alltraps>
...
801060e1:	6a 08                	push   $0x8
  jmp alltraps
801060e3:	e9 ff fa ff ff       	jmp    80105be7 <alltraps>
...
801060ea:	6a 09                	push   $0x9
  jmp alltraps
801060ec:	e9 f6 fa ff ff       	jmp    80105be7 <alltraps>
...
801060f1:	6a 0a                	push   $0xa
  jmp alltraps
801060f3:	e9 ef fa ff ff       	jmp    80105be7 <alltraps>
...
801060f8:	6a 0b                	push   $0xb
  jmp alltraps
801060fa:	e9 e8 fa ff ff       	jmp    80105be7 <alltraps>
...
801060ff:	6a 0c                	push   $0xc
  jmp alltraps
80106101:	e9 e1 fa ff ff       	jmp    80105be7 <alltraps>
...
80106106:	6a 0d                	push   $0xd
  jmp alltraps
80106108:	e9 da fa ff ff       	jmp    80105be7 <alltraps>
...
8010610d:	6a 0e                	push   $0xe
  jmp alltraps
8010610f:	e9 d3 fa ff ff       	jmp    80105be7 <alltraps>
...
80106116:	6a 0f                	push   $0xf
  jmp alltraps
80106118:	e9 ca fa ff ff       	jmp    80105be7 <alltraps>
...
8010611f:	6a 10                	push   $0x10
  jmp alltraps
80106121:	e9 c1 fa ff ff       	jmp    80105be7 <alltraps>
...
80106126:	6a 11                	push   $0x11
  jmp alltraps
80106128:	e9 ba fa ff ff       	jmp    80105be7 <alltraps>
...
8010612f:	6a 12                	push   $0x12
  jmp alltraps
80106131:	e9 b1 fa ff ff       	jmp    80105be7 <alltraps>
...
80106138:	6a 13                	push   $0x13
  jmp alltraps
8010613a:	e9 a8 fa ff ff       	jmp    80105be7 <alltraps>
...
80106141:	6a 14                	push   $0x14
  jmp alltraps
80106143:	e9 9f fa ff ff       	jmp    80105be7 <alltraps>
...
8010614a:	6a 15                	push   $0x15
  jmp alltraps
8010614c:	e9 96 fa ff ff       	jmp    80105be7 <alltraps>
...
80106153:	6a 16                	push   $0x16
  jmp alltraps
80106155:	e9 8d fa ff ff       	jmp    80105be7 <alltraps>
...
8010615c:	6a 17                	push   $0x17
  jmp alltraps
8010615e:	e9 84 fa ff ff       	jmp    80105be7 <alltraps>
...
80106165:	6a 18                	push   $0x18
  jmp alltraps
80106167:	e9 7b fa ff ff       	jmp    80105be7 <alltraps>
...
8010616e:	6a 19                	push   $0x19
  jmp alltraps
80106170:	e9 72 fa ff ff       	jmp    80105be7 <alltraps>
...
80106177:	6a 1a                	push   $0x1a
  jmp alltraps
80106179:	e9 69 fa ff ff       	jmp    80105be7 <alltraps>
...
80106180:	6a 1b                	push   $0x1b
  jmp alltraps
80106182:	e9 60 fa ff ff       	jmp    80105be7 <alltraps>
...
80106189:	6a 1c                	push   $0x1c
  jmp alltraps
8010618b:	e9 57 fa ff ff       	jmp    80105be7 <alltraps>
...
8010619b:	6a 1e                	push   $0x1e
  jmp alltraps
8010619d:	e9 45 fa ff ff       	jmp    80105be7 <alltraps>
...
801061a4:	6a 1f                	push   $0x1f
  jmp alltraps
801061a6:	e9 3c fa ff ff       	jmp    80105be7 <alltraps>
...
801061ad:	6a 20                	push   $0x20
  jmp alltraps
801061af:	e9 33 fa ff ff       	jmp    80105be7 <alltraps>
...
801061b6:	6a 21                	push   $0x21
  jmp alltraps
801061b8:	e9 2a fa ff ff       	jmp    80105be7 <alltraps>
...
801061bf:	6a 22                	push   $0x22
  jmp alltraps
801061c1:	e9 21 fa ff ff       	jmp    80105be7 <alltraps>
...
801061c8:	6a 23                	push   $0x23
  jmp alltraps
801061ca:	e9 18 fa ff ff       	jmp    80105be7 <alltraps>
...
801061d1:	6a 24                	push   $0x24
  jmp alltraps
801061d3:	e9 0f fa ff ff       	jmp    80105be7 <alltraps>
...
801061da:	6a 25                	push   $0x25
  jmp alltraps
801061dc:	e9 06 fa ff ff       	jmp    80105be7 <alltraps>
...
801061e3:	6a 26                	push   $0x26
  jmp alltraps
801061e5:	e9 fd f9 ff ff       	jmp    80105be7 <alltraps>
...
801061ec:	6a 27                	push   $0x27
  jmp alltraps
801061ee:	e9 f4 f9 ff ff       	jmp    80105be7 <alltraps>
...
801061f5:	6a 28                	push   $0x28
  jmp alltraps
801061f7:	e9 eb f9 ff ff       	jmp    80105be7 <alltraps>
...
801061fe:	6a 29                	push   $0x29
  jmp alltraps
80106200:	e9 e2 f9 ff ff       	jmp    80105be7 <alltraps>
...
80106207:	6a 2a                	push   $0x2a
  jmp alltraps
80106209:	e9 d9 f9 ff ff       	jmp    80105be7 <alltraps>
...
80106210:	6a 2b                	push   $0x2b
  jmp alltraps
80106212:	e9 d0 f9 ff ff       	jmp    80105be7 <alltraps>
...
80106219:	6a 2c                	push   $0x2c
  jmp alltraps
8010621b:	e9 c7 f9 ff ff       	jmp    80105be7 <alltraps>
...
80106222:	6a 2d                	push   $0x2d
  jmp alltraps
80106224:	e9 be f9 ff ff       	jmp    80105be7 <alltraps>
...
8010622b:	6a 2e                	push   $0x2e
  jmp alltraps
8010622d:	e9 b5 f9 ff ff       	jmp    80105be7 <alltraps>
...
80106234:	6a 2f                	push   $0x2f
  jmp alltraps
80106236:	e9 ac f9 ff ff       	jmp    80105be7 <alltraps>
...
8010623d:	6a 30                	push   $0x30
  jmp alltraps
8010623f:	e9 a3 f9 ff ff       	jmp    80105be7 <alltraps>
...
80106246:	6a 31                	push   $0x31
  jmp alltraps
80106248:	e9 9a f9 ff ff       	jmp    80105be7 <alltraps>
...
8010624f:	6a 32                	push   $0x32
  jmp alltraps
80106251:	e9 91 f9 ff ff       	jmp    80105be7 <alltraps>
...
80106258:	6a 33                	push   $0x33
  jmp alltraps
8010625a:	e9 88 f9 ff ff       	jmp    80105be7 <alltraps>
...
80106261:	6a 34                	push   $0x34
  jmp alltraps
80106263:	e9 7f f9 ff ff       	jmp    80105be7 <alltraps>
...
8010626a:	6a 35                	push   $0x35
  jmp alltraps
8010626c:	e9 76 f9 ff ff       	jmp    80105be7 <alltraps>
...
80106273:	6a 36                	push   $0x36
  jmp alltraps
80106275:	e9 6d f9 ff ff       	jmp    80105be7 <alltraps>
...
8010627c:	6a 37                	push   $0x37
  jmp alltraps
8010627e:	e9 64 f9 ff ff       	jmp    80105be7 <alltraps>
...
80106285:	6a 38                	push   $0x38
  jmp alltraps
80106287:	e9 5b f9 ff ff       	jmp    80105be7 <alltraps>
...
8010628e:	6a 39                	push   $0x39
  jmp alltraps
80106290:	e9 52 f9 ff ff       	jmp    80105be7 <alltraps>
...
80106297:	6a 3a                	push   $0x3a
  jmp alltraps
80106299:	e9 49 f9 ff ff       	jmp    80105be7 <alltraps>
...
801062a0:	6a 3b                	push   $0x3b
  jmp alltraps
801062a2:	e9 40 f9 ff ff       	jmp    80105be7 <alltraps>
...
801062a9:	6a 3c                	push   $0x3c
  jmp alltraps
801062ab:	e9 37 f9 ff ff       	jmp    80105be7 <alltraps>
...
801062b2:	6a 3d                	push   $0x3d
  jmp alltraps
801062b4:	e9 2e f9 ff ff       	jmp    80105be7 <alltraps>
...
801062bb:	6a 3e                	push   $0x3e
  jmp alltraps
801062bd:	e9 25 f9 ff ff       	jmp    80105be7 <alltraps>
...
801062c4:	6a 3f                	push   $0x3f
  jmp alltraps
801062c6:	e9 1c f9 ff ff       	jmp    80105be7 <alltraps>
...
801062cd:	6a 40                	push   $0x40
  jmp alltraps
801062cf:	e9 13 f9 ff ff       	jmp    80105be7 <alltraps>
...
801062d6:	6a 41                	push   $0x41
  jmp alltraps
801062d8:	e9 0a f9 ff ff       	jmp    80105be7 <alltraps>
...
801062df:	6a 42                	push   $0x42
  jmp alltraps
801062e1:	e9 01 f9 ff ff       	jmp    80105be7 <alltraps>
...
801062e8:	6a 43                	push   $0x43
  jmp alltraps
801062ea:	e9 f8 f8 ff ff       	jmp    80105be7 <alltraps>
...
801062f1:	6a 44                	push   $0x44
  jmp alltraps
801062f3:	e9 ef f8 ff ff       	jmp    80105be7 <alltraps>
...
801062fa:	6a 45                	push   $0x45
  jmp alltraps
801062fc:	e9 e6 f8 ff ff       	jmp    80105be7 <alltraps>
...
80106303:	6a 46                	push   $0x46
  jmp alltraps
80106305:	e9 dd f8 ff ff       	jmp    80105be7 <alltraps>
...
8010630c:	6a 47                	push   $0x47
  jmp alltraps
8010630e:	e9 d4 f8 ff ff       	jmp    80105be7 <alltraps>
...
80106315:	6a 48                	push   $0x48
  jmp alltraps
80106317:	e9 cb f8 ff ff       	jmp    80105be7 <alltraps>
...
8010631e:	6a 49                	push   $0x49
  jmp alltraps
80106320:	e9 c2 f8 ff ff       	jmp    80105be7 <alltraps>
...
80106327:	6a 4a                	push   $0x4a
  jmp alltraps
80106329:	e9 b9 f8 ff ff       	jmp    80105be7 <alltraps>
...
80106330:	6a 4b                	push   $0x4b
  jmp alltraps
80106332:	e9 b0 f8 ff ff       	jmp    80105be7 <alltraps>
...
80106339:	6a 4c                	push   $0x4c
  jmp alltraps
8010633b:	e9 a7 f8 ff ff       	jmp    80105be7 <alltraps>
...
80106342:	6a 4d                	push   $0x4d
  jmp alltraps
80106344:	e9 9e f8 ff ff       	jmp    80105be7 <alltraps>
...
8010634b:	6a 4e                	push   $0x4e
  jmp alltraps
8010634d:	e9 95 f8 ff ff       	jmp    80105be7 <alltraps>
...
80106354:	6a 4f                	push   $0x4f
  jmp alltraps
80106356:	e9 8c f8 ff ff       	jmp    80105be7 <alltraps>
...
8010635d:	6a 50                	push   $0x50
  jmp alltraps
8010635f:	e9 83 f8 ff ff       	jmp    80105be7 <alltraps>
...
80106366:	6a 51                	push   $0x51
  jmp alltraps
80106368:	e9 7a f8 ff ff       	jmp    80105be7 <alltraps>
...
8010636f:	6a 52                	push   $0x52
  jmp alltraps
80106371:	e9 71 f8 ff ff       	jmp    80105be7 <alltraps>
...
80106378:	6a 53                	push   $0x53
  jmp alltraps
8010637a:	e9 68 f8 ff ff       	jmp    80105be7 <alltraps>
...
80106381:	6a 54                	push   $0x54
  jmp alltraps
80106383:	e9 5f f8 ff ff       	jmp    80105be7 <alltraps>
...
8010638a:	6a 55                	push   $0x55
  jmp alltraps
8010638c:	e9 56 f8 ff ff       	jmp    80105be7 <alltraps>
...
80106393:	6a 56                	push   $0x56
  jmp alltraps
80106395:	e9 4d f8 ff ff       	jmp    80105be7 <alltraps>
...
8010639c:	6a 57                	push   $0x57
  jmp alltraps
8010639e:	e9 44 f8 ff ff       	jmp    80105be7 <alltraps>
...
801063a5:	6a 58                	push   $0x58
  jmp alltraps
801063a7:	e9 3b f8 ff ff       	jmp    80105be7 <alltraps>
...
801063ae:	6a 59                	push   $0x59
  jmp alltraps
801063b0:	e9 32 f8 ff ff       	jmp    80105be7 <alltraps>
...
801063b7:	6a 5a                	push   $0x5a
  jmp alltraps
801063b9:	e9 29 f8 ff ff       	jmp    80105be7 <alltraps>
...
801063c0:	6a 5b                	push   $0x5b
  jmp alltraps
801063c2:	e9 20 f8 ff ff       	jmp    80105be7 <alltraps>
...
801063c9:	6a 5c                	push   $0x5c
  jmp alltraps
801063cb:	e9 17 f8 ff ff       	jmp    80105be7 <alltraps>
...
801063d2:	6a 5d                	push   $0x5d
  jmp alltraps
801063d4:	e9 0e f8 ff ff       	jmp    80105be7 <alltraps>
...
801063db:	6a 5e                	push   $0x5e
  jmp alltraps
801063dd:	e9 05 f8 ff ff       	jmp    80105be7 <alltraps>
...
801063e4:	6a 5f                	push   $0x5f
  jmp alltraps
801063e6:	e9 fc f7 ff ff       	jmp    80105be7 <alltraps>
...
801063ed:	6a 60                	push   $0x60
  jmp alltraps
801063ef:	e9 f3 f7 ff ff       	jmp    80105be7 <alltraps>
...
801063f6:	6a 61                	push   $0x61
  jmp alltraps
801063f8:	e9 ea f7 ff ff       	jmp    80105be7 <alltraps>
...
801063ff:	6a 62                	push   $0x62
  jmp alltraps
80106401:	e9 e1 f7 ff ff       	jmp    80105be7 <alltraps>
...
80106408:	6a 63                	push   $0x63
  jmp alltraps
8010640a:	e9 d8 f7 ff ff       	jmp    80105be7 <alltraps>
...
80106411:	6a 64                	push   $0x64
  jmp alltraps
80106413:	e9 cf f7 ff ff       	jmp    80105be7 <alltraps>
...
8010641a:	6a 65                	push   $0x65
  jmp alltraps
8010641c:	e9 c6 f7 ff ff       	jmp    80105be7 <alltraps>
...
80106423:	6a 66                	push   $0x66
  jmp alltraps
80106425:	e9 bd f7 ff ff       	jmp    80105be7 <alltraps>
...
8010642c:	6a 67                	push   $0x67
  jmp alltraps
8010642e:	e9 b4 f7 ff ff       	jmp    80105be7 <alltraps>
...
80106435:	6a 68                	push   $0x68
  jmp alltraps
80106437:	e9 ab f7 ff ff       	jmp    80105be7 <alltraps>
...
8010643e:	6a 69                	push   $0x69
  jmp alltraps
80106440:	e9 a2 f7 ff ff       	jmp    80105be7 <alltraps>
...
80106447:	6a 6a                	push   $0x6a
  jmp alltraps
80106449:	e9 99 f7 ff ff       	jmp    80105be7 <alltraps>
...
80106450:	6a 6b                	push   $0x6b
  jmp alltraps
80106452:	e9 90 f7 ff ff       	jmp    80105be7 <alltraps>
...
80106459:	6a 6c                	push   $0x6c
  jmp alltraps
8010645b:	e9 87 f7 ff ff       	jmp    80105be7 <alltraps>
...
80106462:	6a 6d                	push   $0x6d
  jmp alltraps
80106464:	e9 7e f7 ff ff       	jmp    80105be7 <alltraps>
...
8010646b:	6a 6e                	push   $0x6e
  jmp alltraps
8010646d:	e9 75 f7 ff ff       	jmp    80105be7 <alltraps>
...
80106474:	6a 6f                	push   $0x6f
  jmp alltraps
80106476:	e9 6c f7 ff ff       	jmp    80105be7 <alltraps>
...
8010647d:	6a 70                	push   $0x70
  jmp alltraps
8010647f:	e9 63 f7 ff ff       	jmp    80105be7 <alltraps>
...
80106486:	6a 71                	push   $0x71
  jmp alltraps
80106488:	e9 5a f7 ff ff       	jmp    80105be7 <alltraps>
...
8010648f:	6a 72                	push   $0x72
  jmp alltraps
80106491:	e9 51 f7 ff ff       	jmp    80105be7 <alltraps>
...
80106498:	6a 73                	push   $0x73
  jmp alltraps
8010649a:	e9 48 f7 ff ff       	jmp    80105be7 <alltraps>
...
801064a1:	6a 74                	push   $0x74
  jmp alltraps
801064a3:	e9 3f f7 ff ff       	jmp    80105be7 <alltraps>
...
801064aa:	6a 75                	push   $0x75
  jmp alltraps
801064ac:	e9 36 f7 ff ff       	jmp    80105be7 <alltraps>
...
801064b3:	6a 76                	push   $0x76
  jmp alltraps
801064b5:	e9 2d f7 ff ff       	jmp    80105be7 <alltraps>
...
801064bc:	6a 77                	push   $0x77
  jmp alltraps
801064be:	e9 24 f7 ff ff       	jmp    80105be7 <alltraps>
...
801064c5:	6a 78                	push   $0x78
  jmp alltraps
801064c7:	e9 1b f7 ff ff       	jmp    80105be7 <alltraps>
...
801064ce:	6a 79                	push   $0x79
  jmp alltraps
801064d0:	e9 12 f7 ff ff       	jmp    80105be7 <alltraps>
...
801064d7:	6a 7a                	push   $0x7a
  jmp alltraps
801064d9:	e9 09 f7 ff ff       	jmp    80105be7 <alltraps>
...
801064e0:	6a 7b                	push   $0x7b
  jmp alltraps
801064e2:	e9 00 f7 ff ff       	jmp    80105be7 <alltraps>
...
801064e9:	6a 7c                	push   $0x7c
  jmp alltraps
801064eb:	e9 f7 f6 ff ff       	jmp    80105be7 <alltraps>
...
801064f2:	6a 7d                	push   $0x7d
  jmp alltraps
801064f4:	e9 ee f6 ff ff       	jmp    80105be7 <alltraps>
...
801064fb:	6a 7e                	push   $0x7e
  jmp alltraps
801064fd:	e9 e5 f6 ff ff       	jmp    80105be7 <alltraps>
...
80106504:	6a 7f                	push   $0x7f
  jmp alltraps
80106506:	e9 dc f6 ff ff       	jmp    80105be7 <alltraps>
...
8010650d:	68 80 00 00 00       	push   $0x80
  jmp alltraps
80106512:	e9 d0 f6 ff ff       	jmp    80105be7 <alltraps>
...
80106519:	68 81 00 00 00       	push   $0x81
  jmp alltraps
8010651e:	e9 c4 f6 ff ff       	jmp    80105be7 <alltraps>
...
80106525:	68 82 00 00 00       	push   $0x82
  jmp alltraps
8010652a:	e9 b8 f6 ff ff       	jmp    80105be7 <alltraps>
...
80106531:	68 83 00 00 00       	push   $0x83
  jmp alltraps
80106536:	e9 ac f6 ff ff       	jmp    80105be7 <alltraps>
...
8010653d:	68 84 00 00 00       	push   $0x84
  jmp alltraps
80106542:	e9 a0 f6 ff ff       	jmp    80105be7 <alltraps>
...
80106549:	68 85 00 00 00       	push   $0x85
  jmp alltraps
8010654e:	e9 94 f6 ff ff       	jmp    80105be7 <alltraps>
...
80106555:	68 86 00 00 00       	push   $0x86
  jmp alltraps
8010655a:	e9 88 f6 ff ff       	jmp    80105be7 <alltraps>
...
80106561:	68 87 00 00 00       	push   $0x87
  jmp alltraps
80106566:	e9 7c f6 ff ff       	jmp    80105be7 <alltraps>
...
8010656d:	68 88 00 00 00       	push   $0x88
  jmp alltraps
80106572:	e9 70 f6 ff ff       	jmp    80105be7 <alltraps>
...
80106579:	68 89 00 00 00       	push   $0x89
  jmp alltraps
8010657e:	e9 64 f6 ff ff       	jmp    80105be7 <alltraps>
...
80106585:	68 8a 00 00 00       	push   $0x8a
  jmp alltraps
8010658a:	e9 58 f6 ff ff       	jmp    80105be7 <alltraps>
...
80106591:	68 8b 00 00 00       	push   $0x8b
  jmp alltraps
80106596:	e9 4c f6 ff ff       	jmp    80105be7 <alltraps>
...
8010659d:	68 8c 00 00 00       	push   $0x8c
  jmp alltraps
801065a2:	e9 40 f6 ff ff       	jmp    80105be7 <alltraps>
...
801065a9:	68 8d 00 00 00       	push   $0x8d
  jmp alltraps
801065ae:	e9 34 f6 ff ff       	jmp    80105be7 <alltraps>
...
801065b5:	68 8e 00 00 00       	push   $0x8e
  jmp alltraps
801065ba:	e9 28 f6 ff ff       	jmp    80105be7 <alltraps>
...
801065c1:	68 8f 00 00 00       	push   $0x8f
  jmp alltraps
801065c6:	e9 1c f6 ff ff       	jmp    80105be7 <alltraps>
...
801065cd:	68 90 00 00 00       	push   $0x90
  jmp alltraps
801065d2:	e9 10 f6 ff ff       	jmp    80105be7 <alltraps>
...
801065d9:	68 91 00 00 00       	push   $0x91
  jmp alltraps
801065de:	e9 04 f6 ff ff       	jmp    80105be7 <alltraps>
...
801065e5:	68 92 00 00 00       	push   $0x92
  jmp alltraps
801065ea:	e9 f8 f5 ff ff       	jmp    80105be7 <alltraps>
...
801065f1:	68 93 00 00 00       	push   $0x93
  jmp alltraps
801065f6:	e9 ec f5 ff ff       	jmp    80105be7 <alltraps>
...
801065fd:	68 94 00 00 00       	push   $0x94
  jmp alltraps
80106602:	e9 e0 f5 ff ff       	jmp    80105be7 <alltraps>
...
80106609:	68 95 00 00 00       	push   $0x95
  jmp alltraps
8010660e:	e9 d4 f5 ff ff       	jmp    80105be7 <alltraps>
...
80106615:	68 96 00 00 00       	push   $0x96
  jmp alltraps
8010661a:	e9 c8 f5 ff ff       	jmp    80105be7 <alltraps>
...
80106621:	68 97 00 00 00       	push   $0x97
  jmp alltraps
80106626:	e9 bc f5 ff ff       	jmp    80105be7 <alltraps>
...
8010662d:	68 98 00 00 00       	push   $0x98
  jmp alltraps
80106632:	e9 b0 f5 ff ff       	jmp    80105be7 <alltraps>
...
80106639:	68 99 00 00 00       	push   $0x99
  jmp alltraps
8010663e:	e9 a4 f5 ff ff       	jmp    80105be7 <alltraps>
...
80106645:	68 9a 00 00 00       	push   $0x9a
  jmp alltraps
8010664a:	e9 98 f5 ff ff       	jmp    80105be7 <alltraps>
...
80106651:	68 9b 00 00 00       	push   $0x9b
  jmp alltraps
80106656:	e9 8c f5 ff ff       	jmp    80105be7 <alltraps>
...
8010665d:	68 9c 00 00 00       	push   $0x9c
  jmp alltraps
80106662:	e9 80 f5 ff ff       	jmp    80105be7 <alltraps>
...
80106669:	68 9d 00 00 00       	push   $0x9d
  jmp alltraps
8010666e:	e9 74 f5 ff ff       	jmp    80105be7 <alltraps>
...
80106675:	68 9e 00 00 00       	push   $0x9e
  jmp alltraps
8010667a:	e9 68 f5 ff ff       	jmp    80105be7 <alltraps>
...
80106681:	68 9f 00 00 00       	push   $0x9f
  jmp alltraps
80106686:	e9 5c f5 ff ff       	jmp    80105be7 <alltraps>
...
8010668d:	68 a0 00 00 00       	push   $0xa0
  jmp alltraps
80106692:	e9 50 f5 ff ff       	jmp    80105be7 <alltraps>
...
80106699:	68 a1 00 00 00       	push   $0xa1
  jmp alltraps
8010669e:	e9 44 f5 ff ff       	jmp    80105be7 <alltraps>
...
801066a5:	68 a2 00 00 00       	push   $0xa2
  jmp alltraps
801066aa:	e9 38 f5 ff ff       	jmp    80105be7 <alltraps>
...
801066b1:	68 a3 00 00 00       	push   $0xa3
  jmp alltraps
801066b6:	e9 2c f5 ff ff       	jmp    80105be7 <alltraps>
...
801066bd:	68 a4 00 00 00       	push   $0xa4
  jmp alltraps
801066c2:	e9 20 f5 ff ff       	jmp    80105be7 <alltraps>
...
801066c9:	68 a5 00 00 00       	push   $0xa5
  jmp alltraps
801066ce:	e9 14 f5 ff ff       	jmp    80105be7 <alltraps>
...
801066d5:	68 a6 00 00 00       	push   $0xa6
  jmp alltraps
801066da:	e9 08 f5 ff ff       	jmp    80105be7 <alltraps>
...
801066e1:	68 a7 00 00 00       	push   $0xa7
  jmp alltraps
801066e6:	e9 fc f4 ff ff       	jmp    80105be7 <alltraps>
...
801066ed:	68 a8 00 00 00       	push   $0xa8
  jmp alltraps
801066f2:	e9 f0 f4 ff ff       	jmp    80105be7 <alltraps>
...
801066f9:	68 a9 00 00 00       	push   $0xa9
  jmp alltraps
801066fe:	e9 e4 f4 ff ff       	jmp    80105be7 <alltraps>
...
80106705:	68 aa 00 00 00       	push   $0xaa
  jmp alltraps
8010670a:	e9 d8 f4 ff ff       	jmp    80105be7 <alltraps>
...
80106711:	68 ab 00 00 00       	push   $0xab
  jmp alltraps
80106716:	e9 cc f4 ff ff       	jmp    80105be7 <alltraps>
...
8010671d:	68 ac 00 00 00       	push   $0xac
  jmp alltraps
80106722:	e9 c0 f4 ff ff       	jmp    80105be7 <alltraps>
...
80106729:	68 ad 00 00 00       	push   $0xad
  jmp alltraps
8010672e:	e9 b4 f4 ff ff       	jmp    80105be7 <alltraps>
...
80106735:	68 ae 00 00 00       	push   $0xae
  jmp alltraps
8010673a:	e9 a8 f4 ff ff       	jmp    80105be7 <alltraps>
...
80106741:	68 af 00 00 00       	push   $0xaf
  jmp alltraps
80106746:	e9 9c f4 ff ff       	jmp    80105be7 <alltraps>
...
8010674d:	68 b0 00 00 00       	push   $0xb0
  jmp alltraps
80106752:	e9 90 f4 ff ff       	jmp    80105be7 <alltraps>
...
80106759:	68 b1 00 00 00       	push   $0xb1
  jmp alltraps
8010675e:	e9 84 f4 ff ff       	jmp    80105be7 <alltraps>
...
80106765:	68 b2 00 00 00       	push   $0xb2
  jmp alltraps
8010676a:	e9 78 f4 ff ff       	jmp    80105be7 <alltraps>
...
80106771:	68 b3 00 00 00       	push   $0xb3
  jmp alltraps
80106776:	e9 6c f4 ff ff       	jmp    80105be7 <alltraps>
...
8010677d:	68 b4 00 00 00       	push   $0xb4
  jmp alltraps
80106782:	e9 60 f4 ff ff       	jmp    80105be7 <alltraps>
...
80106789:	68 b5 00 00 00       	push   $0xb5
  jmp alltraps
8010678e:	e9 54 f4 ff ff       	jmp    80105be7 <alltraps>
...
80106795:	68 b6 00 00 00       	push   $0xb6
  jmp alltraps
8010679a:	e9 48 f4 ff ff       	jmp    80105be7 <alltraps>
...
801067a1:	68 b7 00 00 00       	push   $0xb7
  jmp alltraps
801067a6:	e9 3c f4 ff ff       	jmp    80105be7 <alltraps>
...
801067ad:	68 b8 00 00 00       	push   $0xb8
  jmp alltraps
801067b2:	e9 30 f4 ff ff       	jmp    80105be7 <alltraps>
...
801067b9:	68 b9 00 00 00       	push   $0xb9
  jmp alltraps
801067be:	e9 24 f4 ff ff       	jmp    80105be7 <alltraps>
...
801067c5:	68 ba 00 00 00       	push   $0xba
  jmp alltraps
801067ca:	e9 18 f4 ff ff       	jmp    80105be7 <alltraps>
...
801067d1:	68 bb 00 00 00       	push   $0xbb
  jmp alltraps
801067d6:	e9 0c f4 ff ff       	jmp    80105be7 <alltraps>
...
801067dd:	68 bc 00 00 00       	push   $0xbc
  jmp alltraps
801067e2:	e9 00 f4 ff ff       	jmp    80105be7 <alltraps>
...
801067e9:	68 bd 00 00 00       	push   $0xbd
  jmp alltraps
801067ee:	e9 f4 f3 ff ff       	jmp    80105be7 <alltraps>
...
801067f5:	68 be 00 00 00       	push   $0xbe
  jmp alltraps
801067fa:	e9 e8 f3 ff ff       	jmp    80105be7 <alltraps>
...
80106801:	68 bf 00 00 00       	push   $0xbf
  jmp alltraps
80106806:	e9 dc f3 ff ff       	jmp    80105be7 <alltraps>
...
8010680d:	68 c0 00 00 00       	push   $0xc0
  jmp alltraps
80106812:	e9 d0 f3 ff ff       	jmp    80105be7 <alltraps>
...
80106819:	68 c1 00 00 00       	push   $0xc1
  jmp alltraps
8010681e:	e9 c4 f3 ff ff       	jmp    80105be7 <alltraps>
...
80106825:	68 c2 00 00 00       	push   $0xc2
  jmp alltraps
8010682a:	e9 b8 f3 ff ff       	jmp    80105be7 <alltraps>
...
80106831:	68 c3 00 00 00       	push   $0xc3
  jmp alltraps
80106836:	e9 ac f3 ff ff       	jmp    80105be7 <alltraps>
...
8010683d:	68 c4 00 00 00       	push   $0xc4
  jmp alltraps
80106842:	e9 a0 f3 ff ff       	jmp    80105be7 <alltraps>
...
80106849:	68 c5 00 00 00       	push   $0xc5
  jmp alltraps
8010684e:	e9 94 f3 ff ff       	jmp    80105be7 <alltraps>
...
80106855:	68 c6 00 00 00       	push   $0xc6
  jmp alltraps
8010685a:	e9 88 f3 ff ff       	jmp    80105be7 <alltraps>
...
80106861:	68 c7 00 00 00       	push   $0xc7
  jmp alltraps
80106866:	e9 7c f3 ff ff       	jmp    80105be7 <alltraps>
...
8010686d:	68 c8 00 00 00       	push   $0xc8
  jmp alltraps
80106872:	e9 70 f3 ff ff       	jmp    80105be7 <alltraps>
...
80106879:	68 c9 00 00 00       	push   $0xc9
  jmp alltraps
8010687e:	e9 64 f3 ff ff       	jmp    80105be7 <alltraps>
...
80106885:	68 ca 00 00 00       	push   $0xca
  jmp alltraps
8010688a:	e9 58 f3 ff ff       	jmp    80105be7 <alltraps>
...
80106891:	68 cb 00 00 00       	push   $0xcb
  jmp alltraps
80106896:	e9 4c f3 ff ff       	jmp    80105be7 <alltraps>
...
8010689d:	68 cc 00 00 00       	push   $0xcc
  jmp alltraps
801068a2:	e9 40 f3 ff ff       	jmp    80105be7 <alltraps>
...
801068a9:	68 cd 00 00 00       	push   $0xcd
  jmp alltraps
801068ae:	e9 34 f3 ff ff       	jmp    80105be7 <alltraps>
...
801068b5:	68 ce 00 00 00       	push   $0xce
  jmp alltraps
801068ba:	e9 28 f3 ff ff       	jmp    80105be7 <alltraps>
...
801068c1:	68 cf 00 00 00       	push   $0xcf
  jmp alltraps
801068c6:	e9 1c f3 ff ff       	jmp    80105be7 <alltraps>
...
801068cd:	68 d0 00 00 00       	push   $0xd0
  jmp alltraps
801068d2:	e9 10 f3 ff ff       	jmp    80105be7 <alltraps>
...
801068d9:	68 d1 00 00 00       	push   $0xd1
  jmp alltraps
801068de:	e9 04 f3 ff ff       	jmp    80105be7 <alltraps>
...
801068e5:	68 d2 00 00 00       	push   $0xd2
  jmp alltraps
801068ea:	e9 f8 f2 ff ff       	jmp    80105be7 <alltraps>
...
801068f1:	68 d3 00 00 00       	push   $0xd3
  jmp alltraps
801068f6:	e9 ec f2 ff ff       	jmp    80105be7 <alltraps>
...
801068fd:	68 d4 00 00 00       	push   $0xd4
  jmp alltraps
80106902:	e9 e0 f2 ff ff       	jmp    80105be7 <alltraps>
...
80106909:	68 d5 00 00 00       	push   $0xd5
  jmp alltraps
8010690e:	e9 d4 f2 ff ff       	jmp    80105be7 <alltraps>
...
80106915:	68 d6 00 00 00       	push   $0xd6
  jmp alltraps
8010691a:	e9 c8 f2 ff ff       	jmp    80105be7 <alltraps>
...
80106921:	68 d7 00 00 00       	push   $0xd7
  jmp alltraps
80106926:	e9 bc f2 ff ff       	jmp    80105be7 <alltraps>
...
8010692d:	68 d8 00 00 00       	push   $0xd8
  jmp alltraps
80106932:	e9 b0 f2 ff ff       	jmp    80105be7 <alltraps>
...
80106939:	68 d9 00 00 00       	push   $0xd9
  jmp alltraps
8010693e:	e9 a4 f2 ff ff       	jmp    80105be7 <alltraps>
...
80106945:	68 da 00 00 00       	push   $0xda
  jmp alltraps
8010694a:	e9 98 f2 ff ff       	jmp    80105be7 <alltraps>
...
80106951:	68 db 00 00 00       	push   $0xdb
  jmp alltraps
80106956:	e9 8c f2 ff ff       	jmp    80105be7 <alltraps>
...
8010695d:	68 dc 00 00 00       	push   $0xdc
  jmp alltraps
80106962:	e9 80 f2 ff ff       	jmp    80105be7 <alltraps>
...
80106969:	68 dd 00 00 00       	push   $0xdd
  jmp alltraps
8010696e:	e9 74 f2 ff ff       	jmp    80105be7 <alltraps>
...
80106975:	68 de 00 00 00       	push   $0xde
  jmp alltraps
8010697a:	e9 68 f2 ff ff       	jmp    80105be7 <alltraps>
...
80106981:	68 df 00 00 00       	push   $0xdf
  jmp alltraps
80106986:	e9 5c f2 ff ff       	jmp    80105be7 <alltraps>
...
8010698d:	68 e0 00 00 00       	push   $0xe0
  jmp alltraps
80106992:	e9 50 f2 ff ff       	jmp    80105be7 <alltraps>
...
80106999:	68 e1 00 00 00       	push   $0xe1
  jmp alltraps
8010699e:	e9 44 f2 ff ff       	jmp    80105be7 <alltraps>
...
801069a5:	68 e2 00 00 00       	push   $0xe2
  jmp alltraps
801069aa:	e9 38 f2 ff ff       	jmp    80105be7 <alltraps>
...
801069b1:	68 e3 00 00 00       	push   $0xe3
  jmp alltraps
801069b6:	e9 2c f2 ff ff       	jmp    80105be7 <alltraps>
...
801069bd:	68 e4 00 00 00       	push   $0xe4
  jmp alltraps
801069c2:	e9 20 f2 ff ff       	jmp    80105be7 <alltraps>
...
801069c9:	68 e5 00 00 00       	push   $0xe5
  jmp alltraps
801069ce:	e9 14 f2 ff ff       	jmp    80105be7 <alltraps>
...
801069d5:	68 e6 00 00 00       	push   $0xe6
  jmp alltraps
801069da:	e9 08 f2 ff ff       	jmp    80105be7 <alltraps>
...
801069e1:	68 e7 00 00 00       	push   $0xe7
  jmp alltraps
801069e6:	e9 fc f1 ff ff       	jmp    80105be7 <alltraps>
...
801069ed:	68 e8 00 00 00       	push   $0xe8
  jmp alltraps
801069f2:	e9 f0 f1 ff ff       	jmp    80105be7 <alltraps>
...
801069f9:	68 e9 00 00 00       	push   $0xe9
  jmp alltraps
801069fe:	e9 e4 f1 ff ff       	jmp    80105be7 <alltraps>
...
80106a05:	68 ea 00 00 00       	push   $0xea
  jmp alltraps
80106a0a:	e9 d8 f1 ff ff       	jmp    80105be7 <alltraps>
...
80106a11:	68 eb 00 00 00       	push   $0xeb
  jmp alltraps
80106a16:	e9 cc f1 ff ff       	jmp    80105be7 <alltraps>
...
80106a1d:	68 ec 00 00 00       	push   $0xec
  jmp alltraps
80106a22:	e9 c0 f1 ff ff       	jmp    80105be7 <alltraps>
...
80106a29:	68 ed 00 00 00       	push   $0xed
  jmp alltraps
80106a2e:	e9 b4 f1 ff ff       	jmp    80105be7 <alltraps>
...
80106a35:	68 ee 00 00 00       	push   $0xee
  jmp alltraps
80106a3a:	e9 a8 f1 ff ff       	jmp    80105be7 <alltraps>
...
80106a41:	68 ef 00 00 00       	push   $0xef
  jmp alltraps
80106a46:	e9 9c f1 ff ff       	jmp    80105be7 <alltraps>
...
80106a4d:	68 f0 00 00 00       	push   $0xf0
  jmp alltraps
80106a52:	e9 90 f1 ff ff       	jmp    80105be7 <alltraps>
...
80106a59:	68 f1 00 00 00       	push   $0xf1
  jmp alltraps
80106a5e:	e9 84 f1 ff ff       	jmp    80105be7 <alltraps>
...
80106a65:	68 f2 00 00 00       	push   $0xf2
  jmp alltraps
80106a6a:	e9 78 f1 ff ff       	jmp    80105be7 <alltraps>
...
80106a71:	68 f3 00 00 00       	push   $0xf3
  jmp alltraps
80106a76:	e9 6c f1 ff ff       	jmp    80105be7 <alltraps>
...
80106a7d:	68 f4 00 00 00       	push   $0xf4
  jmp alltraps
80106a82:	e9 60 f1 ff ff       	jmp    80105be7 <alltraps>
...
80106a89:	68 f5 00 00 00       	push   $0xf5
  jmp alltraps
80106a8e:	e9 54 f1 ff ff       	jmp    80105be7 <alltraps>
...
80106a95:	68 f6 00 00 00       	push   $0xf6
  jmp alltraps
80106a9a:	e9 48 f1 ff ff       	jmp    80105be7 <alltraps>
...
80106aa1:	68 f7 00 00 00       	push   $0xf7
  jmp alltraps
80106aa6:	e9 3c f1 ff ff       	jmp    80105be7 <alltraps>
...
80106aad:	68 f8 00 00 00       	push   $0xf8
  jmp alltraps
80106ab2:	e9 30 f1 ff ff       	jmp    80105be7 <alltraps>
...
80106ab9:	68 f9 00 00 00       	push   $0xf9
  jmp alltraps
80106abe:	e9 24 f1 ff ff       	jmp    80105be7 <alltraps>
...
80106ac5:	68 fa 00 00 00       	push   $0xfa
  jmp alltraps
80106aca:	e9 18 f1 ff ff       	jmp    80105be7 <alltraps>
...
80106ad1:	68 fb 00 00 00       	push   $0xfb
  jmp alltraps
80106ad6:	e9 0c f1 ff ff       	jmp    80105be7 <alltraps>
...
80106add:	68 fc 00 00 00       	push   $0xfc
  jmp alltraps
80106ae2:	e9 00 f1 ff ff       	jmp    80105be7 <alltraps>
...
80106ae9:	68 fd 00 00 00       	push   $0xfd
  jmp alltraps
80106aee:	e9 f4 f0 ff ff       	jmp    80105be7 <alltraps>
...
80106af5:	68 fe 00 00 00       	push   $0xfe
  jmp alltraps
80106afa:	e9 e8 f0 ff ff       	jmp    80105be7 <alltraps>
...
80106b01:	68 ff 00 00 00       	push   $0xff
  jmp alltraps
80106b06:	e9 dc f0 ff ff       	jmp    80105be7 <alltraps>
...
80106b6a:	e8 c1 dd ff ff       	call   80104930 <memset>
    *pde = V2P(pgtab) | PTE_P | PTE_W | PTE_U;
...
80106c0d:	68 fc 7d 10 80       	push   $0x80107dfc
...
80106cd7:	83 ec 18             	sub    $0x18,%esp
  c = &cpus[cpuid()];
80106cda:	e8 61 cc ff ff       	call   80103940 <cpuid>
  pd[0] = size-1;
...
80106d64:	a1 a4 54 11 80       	mov    0x801154a4,%eax
...
80106da8:	0f 84 c2 00 00 00    	je     80106e70 <switchuvm+0xf0>
  pushcli();
80106dae:	e8 6d d9 ff ff       	call   80104720 <pushcli>
  mycpu()->gdt[SEG_TSS] = SEG16(STS_T32A, &mycpu()->ts,
80106db3:	e8 18 cb ff ff       	call   801038d0 <mycpu>
80106db8:	89 c3                	mov    %eax,%ebx
80106dba:	e8 11 cb ff ff       	call   801038d0 <mycpu>
80106dbf:	89 c7                	mov    %eax,%edi
80106dc1:	e8 0a cb ff ff       	call   801038d0 <mycpu>
80106dc6:	83 c7 08             	add    $0x8,%edi
80106dc9:	89 45 e4             	mov    %eax,-0x1c(%ebp)
80106dcc:	e8 ff ca ff ff       	call   801038d0 <mycpu>
...
80106e15:	e8 b6 ca ff ff       	call   801038d0 <mycpu>
...
80106e33:	e8 98 ca ff ff       	call   801038d0 <mycpu>
80106e38:	89 58 0c             	mov    %ebx,0xc(%eax)
  mycpu()->ts.iomb = (ushort) 0xFFFF;
80106e3b:	e8 90 ca ff ff       	call   801038d0 <mycpu>
...
80106ec3:	e8 68 da ff ff       	call   80104930 <memset>
...
80106ef6:	5d                   	pop    %ebp
  memmove(mem, init, sz);
80106ef7:	e9 d4 da ff ff       	jmp    801049d0 <memmove>
    panic("inituvm: more than a page");
80106efc:	83 ec 0c             	sub    $0xc,%esp
80106eff:	68 41 7e 10 80       	push   $0x80107e41
...
8010702b:	e8 00 d9 ff ff       	call   80104930 <memset>
...
80107069:	68 79 7e 10 80       	push   $0x80107e79
...
801070cb:	68 91 7e 10 80       	push   $0x80107e91
...
801071ac:	68 ad 7e 10 80       	push   $0x80107ead
...
801071e4:	e8 47 d7 ff ff       	call   80104930 <memset>
...
8010724f:	a3 a4 54 11 80       	mov    %eax,0x801154a4
  lcr3(V2P(kpgdir));   // switch to the kernel page table
...
80107283:	68 be 7e 10 80       	push   $0x80107ebe
...
801072d0:	e8 fb d6 ff ff       	call   801049d0 <memmove>
...
80107369:	68 e2 7e 10 80       	push   $0x80107ee2
8010736e:	e8 1d 90 ff ff       	call   80100390 <panic>
      panic("copyuvm: pte should exist");
80107373:	83 ec 0c             	sub    $0xc,%esp
80107376:	68 c8 7e 10 80       	push   $0x80107ec8
...
801073fe:	e8 cd d5 ff ff       	call   801049d0 <memmove>
    len -= n;
    buf += n;
