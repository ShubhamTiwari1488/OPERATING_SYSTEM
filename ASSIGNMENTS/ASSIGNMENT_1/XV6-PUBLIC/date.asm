...
int main(int argc, char *argv[]){
  ...
  if(date(&r))
  18:	50                   	push   %eax
  19:	e8 55 03 00 00       	call   373 <date>
  1e:	83 c4 10             	add    $0x10,%esp
  21:	85 c0                	test   %eax,%eax
  23:	75 1b                	jne    40 <main+0x40>
    exit();
    
  printf(1,"%d %d %d\n",r.day,r.month,r.year);
  25:	83 ec 0c             	sub    $0xc,%esp
  28:	ff 75 f4             	pushl  -0xc(%ebp)
  2b:	ff 75 f0             	pushl  -0x10(%ebp)
  2e:	ff 75 ec             	pushl  -0x14(%ebp)
...
printf(int fd, const char *fmt, ...)
{
 ...
 5b4:	eb 1a                	jmp    5d0 <printf+0x1a0>
          s = "(null)";
 5b6:	bb a2 07 00 00       	mov    $0x7a2,%ebx
        while(*s != 0){
...
free(void *ap)
{
 ...
 605:	a1 54 0a 00 00       	mov    0xa54,%eax
{
 ...
 626:	73 10                	jae    638 <free+0x38>
{
 ...
 651:	5b                   	pop    %ebx
  freep = p;
 652:	a3 54 0a 00 00       	mov    %eax,0xa54
}
 657:	5e                   	pop    %esi
 658:	5f                   	pop    %edi
 659:	5d                   	pop    %ebp
...
malloc(uint nbytes)
{
 ...
 69d:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 6a0:	8b 3d 54 0a 00 00    	mov    0xa54,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 6e9:	8b 3d 54 0a 00 00    	mov    0xa54,%edi
 ...
 744:	89 72 04             	mov    %esi,0x4(%edx)
      freep = prevp;
 747:	a3 54 0a 00 00       	mov    %eax,0xa54
}
 ...
 767:	0a 00 00 
    base.s.size = 0;
 76a:	bf 58 0a 00 00       	mov    $0xa58,%edi
    base.s.ptr = freep = prevp = &base;
 76f:	c7 05 58 0a 00 00 58 	movl   $0xa58,0xa58
 776:	0a 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 779:	89 f8                	mov    %edi,%eax
    base.s.size = 0;
 77b:	c7 05 5c 0a 00 00 00 	movl   $0x0,0xa5c
 782:	00 00 00 
    if(p->s.size >= nunits){
